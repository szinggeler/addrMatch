...
var $author$project$GeocodeAddrModel$AddrCols = F4(
	function (street, nrtxt, plz, location) {
		return {location: location, nrtxt: nrtxt, plz: plz, street: street};
	});
var $author$project$GeocodeAddrModel$InputCsvView = {$: 'InputCsvView'};
var $author$project$GeocodeAddrModel$None = {$: 'None'};
...
var $author$project$GeocodeAddrMain$init = function (flags) {
	var model = {
		activeTab: $author$project$GeocodeAddrModel$InputCsvView,
		addrCols: A4($author$project$GeocodeAddrModel$AddrCols, 0, 1, 2, 3),
		anzAddrs: 0,
		arrayQueryAddrs: {headers: $elm$core$Array$empty, records: $elm$core$Array$empty},
		bugList: _List_Nil,
		bugText: '',
		containsHeader: true,
		containsHouseNr: false,
		delim: ';',
		device: $mdgriffith$elm_ui$Element$classifyDevice(flags),
		geocodedAddrs: _List_Nil,
		inAddrString: '',
		inAddrStringBackup: '',
		menuActive: false,
		modalWindow: $author$project$GeocodeAddrModel$None,
		outAddrString: '',
		outTableState: $billstclair$elm_sortable_table$Table$initialSort('Ortschaftsname')
	};
	return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
};
...
var $author$project$GeocodeAddrModel$ParsedView = {$: 'ParsedView'};
var $author$project$GeocodeAddrModel$ResultView = {$: 'ResultView'};
...
var $author$project$GeocodeAddrUpdate$buildOutCsv = function (model) {
	var recValuesToString = function (_v1) {
		var strassenname = _v1.strassenname;
		var hausnummer = _v1.hausnummer;
		var ortschaftsname = _v1.ortschaftsname;
		var plz = _v1.plz;
		var geomx = _v1.geomx;
		var geomy = _v1.geomy;
		var quality = _v1.quality;
		var geodb_oid = _v1.geodb_oid;
		var bfsnr = _v1.bfsnr;
		var kanton = _v1.kanton;
		var separator = (model.delim === ';') ? ',' : ';';
	...
	var geoRows = A2(
		$elm$core$List$map,
		recValuesToString,
		A2($elm$core$List$map, $elm$core$Tuple$second, model.geocodedAddrs));
	var firstRow = A2(
		$elm$core$String$join,
		model.delim,
		_Utils_ap(
			_List_fromArray(
				['GIS-Browser', 'GIS_Strasse', 'GIS_Hausnr', 'GIS_Ort', 'GIS_Plz', 'GIS_Ost', 'GIS_Nord', 'GIS_Qualität', 'GIS_Id', 'GIS_Bfs_Nr', 'GIS_Kanton']),
			$elm$core$Array$toList(model.arrayQueryAddrs.headers)));
	...
	var origRows = A2(
		$elm$core$List$map,
		arrValuesToString,
		A2($elm$core$List$map, $elm$core$Tuple$first, model.geocodedAddrs));
	var nextRows = A2(
		$elm$core$String$join,
		'\n',
		A2(
...
var $author$project$GeocodeAddrModel$GeocodedAddress = F2(
	function (a, b) {
		return {$: 'GeocodedAddress', a: a, b: b};
	});
							...
							return function (geodb_oid) {
								return function (bfsnr) {
									return function (kanton) {
										return {bfsnr: bfsnr, geodb_oid: geodb_oid, geomx: geomx, geomy: geomy, hausnummer: hausnummer, kanton: kanton, ortschaftsname: ortschaftsname, plz: plz, quality: quality, strassenname: strassenname};
									};
								};
							};
						};
...
var $author$project$GeocodeParser$StreetAddress = F3(
	function (street, nr, addition) {
		return {addition: addition, nr: nr, street: street};
	});
					...
					A2(
						...
						$elm$core$String$fromList(
							A2(
								$elm$core$List$map,
								function (c) {
									return $elm$core$Char$isDigit(c) ? c : _Utils_chr(' ');
								},
		...
		switch (msg.$) {
			...
			case 'SetInAddrs':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							delim: $author$project$GeocodeAddrUpdate$bestDelim(newContent),
							inAddrString: newContent
						}),
					$elm$core$Platform$Cmd$none);
			case 'SetOutAddrs':
				var newContent = msg.a;
			...
			case 'SetDelim':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							delim: delim,
							outAddrString: $author$project$GeocodeAddrUpdate$buildOutCsv(
								_Utils_update(
									model,
									{delim: delim}))
						}),
			...
			case 'ToggleTableHeader':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'ToggleContainsHouseNr':
				var containsHouseNr = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{containsHouseNr: containsHouseNr}),
					$elm$core$Platform$Cmd$none);
			case 'PrepAddrs':
				var parsedAddrs = A3($author$project$Csv$arrayParseWith, model.delim, model.containsHeader, model.inAddrString);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeTab: $author$project$GeocodeAddrModel$ParsedView,
							anzAddrs: $elm$core$Array$length(parsedAddrs.records),
							arrayQueryAddrs: parsedAddrs,
							inAddrString: '',
							inAddrStringBackup: model.inAddrString
						}),
					$elm$core$Platform$Cmd$none);
			case 'InputEditString':
				var rowIndex = msg.a;
				var colIndex = msg.b;
				var newValue = msg.c;
				var addrs = model.arrayQueryAddrs;
				var newRecords = A2(
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							arrayQueryAddrs: newArrayQueryAddrs,
							bugText: _Utils_ap(
			...
			case 'GetCoords':
				...
				var toAddressString = F2(
					function (keys, addrarray) {
						return (model.containsHouseNr ? buildStreetNrString : $elm$core$String$join(','))(
							A2(
								$elm$core$List$map,
								function (key) {
									return A2(
				...
				var addrcols = model.addrCols;
				var buildUrl = function (addr) {
					return _Utils_Tuple2(
						url + ('addressxys.json?adresse=' + A2(
							toAddressString,
							_List_fromArray(
								[addrcols.street, addrcols.nrtxt, addrcols.location, addrcols.plz]),
							addr)),
						addr);
				};
				var urls = A2(
					$elm$core$List$map,
					buildUrl,
					$elm$core$Array$toList(model.arrayQueryAddrs.records));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{bugList: _List_Nil}),
			...
			case 'GeocodedAddress':
				if (msg.b.$ === 'Ok') {
					...
					var inputCsv = model.arrayQueryAddrs;
					...
					var newCsvArray = function (address) {
						return _Utils_update(
							inputCsv,
							{
								records: filteredRecords(address)
							});
					};
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								activeTab: _Utils_eq(
									$elm$core$List$length(model.geocodedAddrs) + 1,
									model.anzAddrs) ? $author$project$GeocodeAddrModel$ResultView : $author$project$GeocodeAddrModel$ParsedView,
								arrayQueryAddrs: newCsvArray(addr),
								geocodedAddrs: A2(
									$elm$core$List$cons,
			...
			case 'SetOutTableState':
				var newState = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{outTableState: newState}),
					$elm$core$Platform$Cmd$none);
			case 'ActivateTab':
				var tab = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							activeTab: tab,
							outAddrString: $author$project$GeocodeAddrUpdate$buildOutCsv(model)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ShowWindow':
			...
			case 'SaveAdresses':
				return _Utils_Tuple2(
					model,
					A3($elm$file$File$Download$string, 'geocoded.csv', 'text/csv', model.outAddrString));
			case 'Restart':
				return _Utils_Tuple2(
					_Utils_update(
						model,
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							bugText: '',
							containsHeader: true,
							delim: $author$project$GeocodeAddrUpdate$bestDelim(model.inAddrStringBackup),
							geocodedAddrs: _List_Nil,
							inAddrString: model.inAddrStringBackup,
							inAddrStringBackup: '',
							menuActive: false,
							outAddrString: ''
						}),
			...
			case 'CsvLoaded':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							delim: $author$project$GeocodeAddrUpdate$bestDelim(content),
							inAddrString: content
						}),
					$elm$core$Platform$Cmd$none);
			case 'AddAddrs':
				var testAddrs = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							bugText: '',
							containsHeader: true,
							delim: $author$project$GeocodeAddrUpdate$bestDelim(testAddrs),
							geocodedAddrs: _List_Nil,
							inAddrString: testAddrs,
							inAddrStringBackup: '',
							menuActive: false,
							modalWindow: $author$project$GeocodeAddrModel$None,
							outAddrString: ''
...
var $author$project$MyStyles$fontsize = {l: 28, m: 24, s: 20, xl: 32, xs: 18, xxl: 36, xxs: 16, xxxl: 42, xxxs: 14};
...
var $author$project$MyStyles$defaultFont = _List_fromArray(
	[
		...
		$mdgriffith$elm_ui$Element$Font$size($author$project$MyStyles$fontsize.s),
...
var $author$project$MyStyles$greys = {
	l: _Utils_Tuple3(96, 96, 96),
	m: _Utils_Tuple3(128, 128, 128),
	s: _Utils_Tuple3(160, 160, 160),
	xl: _Utils_Tuple3(64, 64, 64),
	xs: _Utils_Tuple3(192, 192, 192),
	xxl: _Utils_Tuple3(32, 32, 32),
	xxs: _Utils_Tuple3(224, 224, 224),
	xxxl: _Utils_Tuple3(16, 16, 16),
	xxxs: _Utils_Tuple3(245, 245, 245)
};
var $author$project$MyStyles$uiGreyColors = function () {
	...
	return {
		l: buildColor($author$project$MyStyles$greys.l),
		m: buildColor($author$project$MyStyles$greys.m),
		s: buildColor($author$project$MyStyles$greys.s),
		xl: buildColor($author$project$MyStyles$greys.xl),
		xs: buildColor($author$project$MyStyles$greys.xs),
		xxl: buildColor($author$project$MyStyles$greys.xxl),
		xxs: buildColor($author$project$MyStyles$greys.xxs),
		xxxl: buildColor($author$project$MyStyles$greys.xxxl),
		xxxs: buildColor($author$project$MyStyles$greys.xxxs)
	};
}();
var $author$project$Header$colors = {bg: $author$project$MyStyles$uiGreyColors.xxl, logoTxt: $author$project$MyStyles$uiGreyColors.s, menuHighlight: $author$project$MyStyles$uiGreyColors.l, menuIcon: $author$project$MyStyles$uiGreyColors.s, menuIconHighlight: $author$project$MyStyles$uiGreyColors.xl, menuText: $author$project$MyStyles$uiGreyColors.xxs, title: $author$project$MyStyles$uiGreyColors.xxs};
	...
	return A2(
		...
		A2(
			...
			_List_Nil,
			{
				...
				url: 'https://szinggeler.github.io/'
			}));
};
		...
		_List_Nil,
		{
			label: A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$size($author$project$MyStyles$fontsize.s),
						$mdgriffith$elm_ui$Element$Font$color($author$project$Header$colors.logoTxt)
					]),
...
var $author$project$GeocodeAddrModel$ToggleMenu = {$: 'ToggleMenu'};
...
var $author$project$GeocodeAddrModel$About = {$: 'About'};
var $author$project$GeocodeAddrModel$Examples = {$: 'Examples'};
var $author$project$GeocodeAddrModel$ShowWindow = function (a) {
	return {$: 'ShowWindow', a: a};
};
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$home = A5(
	$lattyware$elm_fontawesome$FontAwesome$Icon$Icon,
	'fas',
	'home',
	576,
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Background$color($author$project$Header$colors.menuHighlight)
							]))
					]),
				_List_fromArray(
					[
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Background$color($author$project$Header$colors.bg),
					...
					$mdgriffith$elm_ui$Element$Font$color($author$project$Header$colors.menuText)
				]),
			_List_fromArray(
				[
					A3(menuItem, $lattyware$elm_fontawesome$FontAwesome$Solid$home, 'Beispiel-Adressen', $author$project$GeocodeAddrModel$Examples),
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Font$color($author$project$Header$colors.menuIcon),
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Background$color($author$project$MyStyles$uiGreyColors.xl)
							]))
					]),
				A2(
					$mdgriffith$elm_ui$Element$el,
		...
		return singleLine ? A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					$mdgriffith$elm_ui$Element$Font$color($author$project$Header$colors.title),
		...
		var fontSize = function () {
			...
			switch (_v0.$) {
				case 'Tablet':
					...
					if (_v1.$ === 'Portrait') {
						return $author$project$MyStyles$fontsize.m;
					} else {
						return $author$project$MyStyles$fontsize.l;
					}
				case 'Desktop':
					return $author$project$MyStyles$fontsize.xl;
				case 'BigDesktop':
					return $author$project$MyStyles$fontsize.xxxl;
				default:
					return $author$project$MyStyles$fontsize.m;
			}
		}();
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Header$logoTxt,
						A2($author$project$Header$siteTitle, true, $author$project$MyStyles$fontsize.m)
					])),
				$author$project$Header$menuIco(menuActive)
			]));
};
		...
		[
			...
			$mdgriffith$elm_ui$Element$Background$gradient(
			{
				...
				steps: _List_fromArray(
					[$author$project$MyStyles$uiGreyColors.xs, $author$project$MyStyles$uiGreyColors.xxxs])
			})
		]),
	_List_fromArray(
		[$mdgriffith$elm_ui$Element$none]));
var $author$project$GeocodeAddrModel$SaveAdresses = {$: 'SaveAdresses'};
var $author$project$GeocodeAddrModel$SetOutAddrs = function (a) {
	return {$: 'SetOutAddrs', a: a};
};
					...
					[
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$alignRight,
								$mdgriffith$elm_ui$Element$Background$color($author$project$MyStyles$uiGreyColors.xs),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$spacing(5),
				$mdgriffith$elm_ui$Element$Background$color($author$project$MyStyles$uiGreyColors.xxs)
			]),
		{
			label: A2(
				...
				$mdgriffith$elm_ui$Element$text('CSV-Delimiter wählen')),
			onChange: $author$project$GeocodeAddrModel$SetDelim,
			options: A2($elm$core$List$map, buildOptions, csvDelimiterOptions),
			selected: $elm$core$Maybe$Just(model.delim)
		});
};
...
var $author$project$MyStyles$buttonStyle = function (active) {
	var variStyle = active ? _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Background$color($author$project$MyStyles$uiGreyColors.s),
			$mdgriffith$elm_ui$Element$mouseOver(
			_List_fromArray(
				[
					...
					{
						blur: 10,
						color: $author$project$MyStyles$uiGreyColors.xs,
						offset: _Utils_Tuple2(3, 5),
						size: 1
					})
				])),
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Background$color($author$project$MyStyles$uiGreyColors.m)
				]))
		]) : _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Background$color($author$project$MyStyles$uiGreyColors.xxs)
...
var $author$project$Tab$Helper$helpText = function (txt) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Border$color($author$project$MyStyles$uiGreyColors.xxs),
...
var $author$project$Tab$Export$view = function (model) {
	var saveCsvButton = function () {
		var btnAttrs = _List_fromArray(
			[$mdgriffith$elm_ui$Element$alignRight]);
		var btnActive = $elm$core$String$length(model.outAddrString) > 10;
		return btnActive ? A2(
					...
					btnAttrs)),
			{
				...
				onPress: $elm$core$Maybe$Just($author$project$GeocodeAddrModel$SaveAdresses)
			}) : A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_Utils_ap(
				$author$project$MyStyles$buttonStyle(btnActive),
				...
				_List_fromArray(
					[
							...
							]),
						{
							...
							onChange: $author$project$GeocodeAddrModel$SetOutAddrs,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
									$mdgriffith$elm_ui$Element$text('Nur geokodierte Adressen können exportiert werden'))),
							spellcheck: false,
							text: model.outAddrString
						})
					]))
			]));
};
...
var $billstclair$elm_sortable_table$Table$floatColumn = F2(
	function (name, toFloat) {
		return $billstclair$elm_sortable_table$Table$Column(
			{
				name: name,
				sorter: $billstclair$elm_sortable_table$Table$increasingOrDecreasingBy(toFloat),
				viewData: A2(
					$elm$core$Basics$composeL,
	...
	return $billstclair$elm_sortable_table$Table$customConfig(
		{
					...
					$billstclair$elm_sortable_table$Table$veryCustomColumn(
					{
						...
						viewData: function (data) {
							return buildHtmlIFrameLink(
								_Utils_Tuple2(data.geomx, data.geomy));
						}
					}),
					A2(
			...
			toMsg: $author$project$GeocodeAddrModel$SetOutTableState
		});
};
...
var $author$project$Tab$Geocoded$view = function (model) {
	var outrecs = A2($elm$core$List$map, $elm$core$Tuple$second, model.geocodedAddrs);
	var geocodedAddrsReady = $elm$core$List$length(model.geocodedAddrs) > 0;
	var helpTxt = geocodedAddrsReady ? 'Geokodierte Adressen' : 'Keine geokodierten Adressen vorhanden -> bitte zuerst Input-Tab und Parsed-Tab bearbeiten';
	var showGeocodedAddrs = geocodedAddrsReady ? $mdgriffith$elm_ui$Element$html(
		A3(
			$billstclair$elm_sortable_table$Table$view,
			$author$project$Tab$Geocoded$configOutTab(model.device),
			model.outTableState,
...
var $author$project$GeocodeAddrModel$CsvRequested = {$: 'CsvRequested'};
var $author$project$GeocodeAddrModel$PrepAddrs = {$: 'PrepAddrs'};
var $author$project$GeocodeAddrModel$ResetInput = {$: 'ResetInput'};
var $author$project$GeocodeAddrModel$Restart = {$: 'Restart'};
...
var $author$project$Tab$Helper$parseButtons = function (model) {
	...
	var adrListReady = $elm$core$String$length(model.inAddrString) > 10;
	var adrBackupReady = $elm$core$String$length(model.inAddrStringBackup) > 10;
	var addrsInUse = adrBackupReady || ($elm$core$List$length(model.geocodedAddrs) > 0);
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
									...
									]),
								{
									...
									label: A2(
										...
										A2(
											...
											_List_fromArray(
												[
													$mdgriffith$elm_ui$Element$text('Erste Zeile enthält Spaltenüberschrift')
												]))),
									onChange: $author$project$GeocodeAddrModel$ToggleTableHeader
								}))
						])),
			...
			A2(
					...
					]),
				{
					label: A2(
						...
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('CSV-Adressliste')),
					onChange: $author$project$GeocodeAddrModel$SetInAddrs,
					placeholder: $elm$core$Maybe$Just(
						A2(
							$mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('CSV-Text in dieses Feld kopieren'))),
					spellcheck: false,
					text: model.inAddrString
				}))
		]);
	return A2(
		$mdgriffith$elm_ui$Element$column,
...
var $author$project$Tab$Helper$geocodeButton = function (model) {
	...
	return btnActive ? A2(
		...
		_Utils_ap(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Element$Region$description('Starten Geocoding der Adressliste.'),
				btnAttrs)),
		{
			label: A2(
				$mdgriffith$elm_ui$Element$row,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Match Addresses')
							])),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
			...
			onPress: $elm$core$Maybe$Just($author$project$GeocodeAddrModel$GetCoords)
		}) : A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Element$Region$description('Required parameters for service missing (Strasse, Hausnummer, Plz, Ort)'),
						btnAttrs)),
				{
					label: A2(
						$mdgriffith$elm_ui$Element$row,
...
var $author$project$GeocodeAddrModel$InputEditString = F3(
	function (a, b, c) {
		return {$: 'InputEditString', a: a, b: b, c: c};
	});
...
var $author$project$Tab$Parsed$showParsedAddresses = function (model) {
	var headrow = $author$project$Tab$Parsed$viewTableHeaders(model.arrayQueryAddrs.headers);
	var contentRows = $elm$core$Array$toList(
		A2($elm$core$Array$indexedMap, $author$project$Tab$Parsed$viewTableRow, model.arrayQueryAddrs.records));
	return $mdgriffith$elm_ui$Element$html(
		A2(
			$elm$html$Html$table,
			_List_fromArray(
...
var $author$project$Tab$Parsed$view = function (model) {
	var showBugList = ($elm$core$List$length(model.bugList) > 0) ? A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
		...
		_List_fromArray(
			[
				...
				($elm$core$List$length(model.geocodedAddrs) < 2) ? A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$padding(10),
				...
				$mdgriffith$elm_ui$Element$text('!! Please check your field assignment and input data !!')) : A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$Font$color($author$project$MyStyles$uiGreyColors.xl),
	...
	var progressBar = function () {
		var rate = ($elm$core$List$length(model.geocodedAddrs) / model.anzAddrs) * 100;
				...
				[
					...
					$mdgriffith$elm_ui$Element$text(
						'Geocodierte Adressen: ' + ($elm$core$String$fromInt(
							$elm$core$List$length(model.geocodedAddrs)) + (' von ' + $elm$core$String$fromInt(model.anzAddrs))))),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
						[
								...
								A2(
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Attributes$max(
											$elm$core$String$fromInt(model.anzAddrs)),
											$elm$html$Html$Attributes$value(
											$elm$core$String$fromInt(
												$elm$core$List$length(model.geocodedAddrs)))
										]),
									_List_Nil))),
							A2(
							$mdgriffith$elm_ui$Element$el,
	...
	var parsedAddrsReady = $elm$core$Array$length(model.arrayQueryAddrs.records) > 0;
	var helpTxt = parsedAddrsReady ? 'Wählen Sie die Parameter für die Adresssuche.' : 'Keine Daten für Adresssuche vorhanden -> bitte zuerst Adressliste im Input-Tab parsen';
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A5($author$project$Tab$Parsed$matchCol, 'Strasse', '', model.arrayQueryAddrs.headers, $author$project$GeocodeAddrModel$SetStreetCol, model.addrCols.street),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_Nil,
								A2(
										...
										]),
									{
										...
										onChange: $author$project$GeocodeAddrModel$ToggleContainsHouseNr
									})),
								model.containsHouseNr ? $mdgriffith$elm_ui$Element$none : A5($author$project$Tab$Parsed$matchCol, 'Hausnummer', '', model.arrayQueryAddrs.headers, $author$project$GeocodeAddrModel$SetNrCol, model.addrCols.nrtxt),
								A5($author$project$Tab$Parsed$matchCol, 'Plz (Integer)', '', model.arrayQueryAddrs.headers, $author$project$GeocodeAddrModel$SetPlzCol, model.addrCols.plz),
								A5($author$project$Tab$Parsed$matchCol, 'Ort', '', model.arrayQueryAddrs.headers, $author$project$GeocodeAddrModel$SetLocationCol, model.addrCols.location)
							])),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						geocodeInputOptions,
						(!model.anzAddrs) ? $mdgriffith$elm_ui$Element$none : progressBar,
						showBugList,
						($elm$core$Array$length(model.arrayQueryAddrs.records) > 0) ? A2(
						$mdgriffith$elm_ui$Element$column,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
...
var $author$project$GeocodeAddrModel$ActivateTab = function (a) {
	return {$: 'ActivateTab', a: a};
};
var $author$project$GeocodeAddrModel$ExportCsvView = {$: 'ExportCsvView'};
var $mdgriffith$elm_ui$Internal$Flag$borderStyle = $mdgriffith$elm_ui$Internal$Flag$flag(11);
var $mdgriffith$elm_ui$Element$Border$solid = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$borderStyle, $mdgriffith$elm_ui$Internal$Style$classes.borderSolid);
var $author$project$MyStyles$tabStyle = function (active) {
	var _v0 = active ? _Utils_Tuple2($author$project$MyStyles$uiGreyColors.xs, $author$project$MyStyles$white) : _Utils_Tuple2($author$project$MyStyles$uiGreyColors.xxxs, $author$project$MyStyles$uiGreyColors.xxxs);
...
var $author$project$GeocodeAddrView$tabNavigation = function (model) {
	var navItems = _List_fromArray(
		[
			_Utils_Tuple2('Input', $author$project$GeocodeAddrModel$InputCsvView),
			_Utils_Tuple2('Parsed', $author$project$GeocodeAddrModel$ParsedView),
			_Utils_Tuple2('Geocoded', $author$project$GeocodeAddrModel$ResultView),
			_Utils_Tuple2('Export', $author$project$GeocodeAddrModel$ExportCsvView)
		]);
	var buildNavItems = function (_v0) {
		...
		return A2(
			...
			$author$project$MyStyles$tabStyle(
				_Utils_eq(model.activeTab, activeTab)),
			{
				label: A2(
					$mdgriffith$elm_ui$Element$row,
					_List_Nil,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Background$color($author$project$MyStyles$uiGreyColors.xxxs)
			]),
		_List_fromArray(
			[
				A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					$mdgriffith$elm_ui$Element$Background$color($author$project$MyStyles$uiGreyColors.xl),
					$mdgriffith$elm_ui$Element$Font$color($author$project$MyStyles$uiGreyColors.xxxs),
					$mdgriffith$elm_ui$Element$padding(10),
					$mdgriffith$elm_ui$Element$spacing(15)
				]),
			_List_fromArray(
...
var $author$project$Tab$Modal$windowProperties = _List_fromArray(
	[
		...
		{
			blur: 20,
			color: $author$project$MyStyles$uiGreyColors.m,
			offset: _Utils_Tuple2(0, 0),
			size: 0.1
		})
	]);
		...
		case 'Examples':
			return A2(
				...
				A2(
					...
					_List_fromArray(
						[
							A2($author$project$Tab$Modal$showTitle, $lattyware$elm_fontawesome$FontAwesome$Solid$home, 'Beispiel Adressen'),
							A2(
							$mdgriffith$elm_ui$Element$column,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$text('Testadressen mit eigener Spalte für Hausnummer:')
										])),
									A2(
									$mdgriffith$elm_ui$Element$el,
									_List_fromArray(
		...
		body: _List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[
							A2($author$project$Header$header, model.device, model.menuActive),
...
var $author$project$GeocodeAddrMain$main = $elm$browser$Browser$document(
	{init: $author$project$GeocodeAddrMain$init, subscriptions: $author$project$GeocodeAddrMain$subscriptions, update: $author$project$GeocodeAddrUpdate$update, view: $author$project$GeocodeAddrMain$view});
_Platform_export({'GeocodeAddrMain':{'init':$author$project$GeocodeAddrMain$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.1"},"types":{"message":"GeocodeAddrModel.Msg","aliases":{"GeocodeAddrModel.AddrGeo":{"args":[],"type":"{ strassenname : String.String, hausnummer : String.String, ortschaftsname : String.String, plz : Basics.Int, geomx : Basics.Float, geomy : Basics.Float, quality : Basics.Float, geodb_oid : Basics.Int, bfsnr : Basics.Int, kanton : String.String }"},"Array.Tree":{"args":["a"],"type":"Elm.JsArray.JsArray (Array.Node a)"}},"unions":{"GeocodeAddrModel.Msg":{"args":[],"tags":{"Resize":["Basics.Int","Basics.Int"],"ToggleMenu":[],"SetInAddrs":["String.String"],"SetOutAddrs":["String.String"],"SetDelim":["String.String"],"ToggleTableHeader":["Basics.Bool"],"ToggleContainsHouseNr":["Basics.Bool"],"PrepAddrs":[],"InputEditString":["Basics.Int","Basics.Int","String.String"],"SetStreetCol":["Basics.Int"],"SetNrCol":["Basics.Int"],"SetPlzCol":["Basics.Int"],"SetLocationCol":["Basics.Int"],"GetCoords":[],"GeocodedAddress":["Array.Array String.String","Result.Result Http.Error GeocodeAddrModel.AddrGeo"],"SetOutTableState":["Table.State"],"ActivateTab":["GeocodeAddrModel.ActiveTab"],"ShowWindow":["GeocodeAddrModel.ModalWindow"],"SaveAdresses":[],"Restart":[],"ResetInput":[],"CsvRequested":[],"CsvSelected":["File.File"],"CsvLoaded":["String.String"],"AddAddrs":["String.String"],"MarkdownMsg":["Markdown.Render.MarkdownMsg"]}},"GeocodeAddrModel.ActiveTab":{"args":[],"tags":{"InputCsvView":[],"ParsedView":[],"ResultView":[],"ExportCsvView":[]}},"Array.Array":{"args":["a"],"tags":{"Array_elm_builtin":["Basics.Int","Basics.Int","Array.Tree a","Elm.JsArray.JsArray a"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"File.File":{"args":[],"tags":{"File":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Markdown.Render.MarkdownMsg":{"args":[],"tags":{"IDClicked":["String.String"]}},"GeocodeAddrModel.ModalWindow":{"args":[],"tags":{"About":[],"Examples":[],"Map":["( Basics.Float, Basics.Float )"],"None":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Table.State":{"args":[],"tags":{"State":["String.String","Basics.Bool"]}},"String.String":{"args":[],"tags":{"String":[]}},"Elm.JsArray.JsArray":{"args":["a"],"tags":{"JsArray":["a"]}},"Array.Node":{"args":["a"],"tags":{"SubTree":["Array.Tree a"],"Leaf":["Elm.JsArray.JsArray a"]}}}}})}});}(this));