...
var $author$project$Tab$Geocoded$view = function (model) {
	...
	var helpTxt = geocodedAddrsReady ? 'Geokodierte Adressen. Koordinaten können über die Links überprüft werden. Anschliessend weiter zum Export-Tab.' : 'Keine geokodierten Adressen vorhanden -> bitte zuerst Input-Tab und Parsed-Tab bearbeiten.';
...
var $author$project$Tab$Input$view = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Tab$Helper$helpText('Adressliste im CSV-Format in Textfeld kopieren oder CSV-Datei importiern. Anschliessend Delimiter-Parameter wählen und Text parsen.'),
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Element$Region$description('Benötigte Parameter für die Suche fehlen (Strasse, Hausnummer, Plz, Ort)'),
						btnAttrs)),
				{
					d9: A2(
						$mdgriffith$elm_ui$Element$row,
...
var $author$project$Tab$Parsed$view = function (model) {
	...
	var helpTxt = parsedAddrsReady ? 'Wählen Sie die Parameter für die Adresssuche. Anschliessend Georeferenzierung starten.' : 'Keine Daten für Adresssuche vorhanden -> bitte zuerst Adressliste im Input-Tab parsen.';
